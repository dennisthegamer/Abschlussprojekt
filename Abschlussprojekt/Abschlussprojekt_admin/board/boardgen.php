...
<head>
    ...
    <meta http-equiv="refresh" content="30; url=boardgen.php">
</head>
...
?>
    ...
    <div class="report-container">
        ...
        <div class = "weather-forecast">
           <img src="http://api.openweathermap.org/img/w/<?php echo $data->weather[0]->icon; ?>.png"
           class="weather-icon" /> <?php echo $data->main->temp; ?> &deg;C
...
<!-- Dieser div container beschäftigt sich mit der ausgabe für die "Erreichbare Person / Gruppe". -->
  <div class="tel"> <h1 class="h1_board">Telefonnr</h1>
  <table class = "posttab">
        <tr>
...
<!-- Dieser div container beschäftigt sich mit der ausgabe für die "Post" -->
  <div class="post"><h1 class="h1_board">Post </h1>
